...
```
### Source[FIDENZA by Tyler Hobbs](https://tylerxhobbs.com/fidenza)
### Source[FLOW FIELDS  by Tyler Hobbs](https://tylerxhobbs.com/essays/2020/flow-fields)
### Source[genuary2022_4 by @geokaramanis](https://github.com/gkaramanis/aRtist/blob/main/genuary/2022/2022-04/2022-04.R) ## THANKS TRILLIONS wie immer
...
limit = n_steps * step_length # limits when cacluating lines
...
ggplot(dat_df) +
  ...
  scale_color_gradientn(colours = pals) +
...
ggsave("TheNextNextFidenza.png", width = 10, height = 10, units = "cm")
