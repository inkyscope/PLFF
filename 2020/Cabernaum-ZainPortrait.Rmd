...
```
### Source[aRt by gkaramanis] (https://github.com/gkaramanis/aRt/blob/master/split-bar/points-portraits.R)
```{r}
library(ggplot2)
library(dplyr)
library(magick)
...
img <- image_read("images/Zain.jpg") %>% 
...
ggsave(here("2020", "ZainPortrait.png"), height = 8, width = 7)
  
  
```

```{r}
portrait_rect <- img_df %>% 
  ggplot() +
